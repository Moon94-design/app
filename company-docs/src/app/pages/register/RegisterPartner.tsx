  ...
  return (
    <div className="card">
      ...
      <div style={{ marginTop: 14, display: "grid", gap: 10 }}>
        <div>
          <div className="p" style={{ marginTop: 0 }}>거래처명</div>
          <input className="input" value={draft.name} onChange={(e) => persist({ ...draft, name: e.target.value })} />
        </div>

        <div>
          <div className="p" style={{ marginTop: 0 }}>주소</div>
          <input className="input" value={draft.address} onChange={(e) => persist({ ...draft, address: e.target.value })} />
        </div>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => persist({ ...draft, companyPhone: formatPhoneInput(e.target.value) })}
